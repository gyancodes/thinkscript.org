...
const About = () => {
  return (
    <>
    <div className="bg-gradient-to-r from-rose-100 to-teal-100 mt-4 pb-10 font-mono">



      <div className="flex flex-col justify-center items-center">
        <h1
          className="text-4xl mt-8 py-4 mb-10 sm:text-center sm:text-8xl font-medium text-transparent
        ...
        <p className="mt-6 mb-4 text-lg leading-8 text-gray-600 text-center">
          We are the group of people All embrace a set of common goals and form
          a community built on mutual trust.
        </p>
      </div>

      <div className="flex flex-col justify-center items-center text-center">
        <h1 className="text-3xl mt-14 sm:text-center sm:text-5xl font-medium text-transparent  bg-clip-text  bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-blue-600 via-sky-700 to-violet-400 tracking-normal ">
          Our Vision
        </h1>
      ...
      <h1
        className="text-1xl mt-14 mb-5 text-center sm:text-3xl font-medium text-transparent
                   bg-clip-text  bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))]
                    from-blue-600 via-sky-700 to-violet-400 tracking-normal "
      >
        What is Thinkscript ?
      ...
      <h1
        className="text-1xl mt-20 mb-5 text-center sm:text-3xl font-medium text-transparent
                   bg-clip-text  bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))]
                    from-blue-600 via-sky-700 to-violet-400 tracking-normal "
      >
        Why OpenSource ?
      ...
      <h1 className="text-1xl mt-10 mb-10 text-center sm:text-2xl p-4 sm:ml-24 sm:mr-24 font-extralight text-transparent bg-clip-text bg-black">
        ...
        models from completely dominating the market.
      </h1>
      <hr className="w-48 h-1 mx-auto my-2 bg-gray-100 border-0 rounded md:my-8 dark:bg-gray-700" />
      ...
      <h1 className="text-1xl mt-10 mb-10 text-center sm:text-2xl p-4 sm:ml-24 sm:mr-24 font-extralight text-transparent bg-clip-text bg-black">
        ...
        features, bug fixes, documentation, and much more, there's always a way
      ...
      <h1 className="text-1xl mt-10 mb-10 text-center sm:text-2xl p-4 sm:ml-24 sm:mr-24 font-extralight text-transparent bg-clip-text bg-black">
        ...
        alternative option. Because access to the code base transfers control to
        the people, opensource improves long-term availability and support.
      </h1>
      <hr className="w-48 h-1 mx-auto my-2 bg-gray-100 border-0 rounded md:my-8 dark:bg-gray-700" />
      ...
      <h1 className="text-1xl mt-10 mb-10 text-center sm:text-2xl p-4 sm:ml-24 sm:mr-24 font-extralight text-transparent bg-clip-text bg-black">
        ...
        as through scaled testing, bug reporting, and user feedback.
      </h1>
      <hr className="w-48 h-1 mx-auto my-2 bg-gray-100 border-0 rounded md:my-8 dark:bg-gray-700" />
      ...
      <h1 className="text-1xl mt-10 mb-10 text-center sm:text-2xl p-4 sm:ml-24 sm:mr-24 font-extralight text-transparent bg-clip-text bg-black">
        ...
        projects and thus has a significant impact on the survival of the open
        source mindset.
      </h1>
      <hr className="w-48 h-1 mx-auto my-2 bg-gray-100 border-0 rounded md:my-8 dark:bg-gray-700" />
      ...
      <h1 className="text-1xl mt-10 mb-10 text-center sm:text-2xl p-4 sm:ml-24 sm:mr-24 font-extralight text-transparent bg-clip-text bg-black">
        ...
        Android kernel, VLC media player, Blender, Audacity, Bittorent, PHP,
        MYSQL, Krita, and Virtual Box are just a few examples of world-class
        open-sourcesource software.
      </h1>
      <hr className="w-48 h-1 mx-auto my-2 bg-gray-100 border-0 rounded md:my-8 dark:bg-gray-700" />
      </div>
    </>

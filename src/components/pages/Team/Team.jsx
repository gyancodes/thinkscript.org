  ...
  return (
    <>
      <div className="flex justify-center flex-col items-center w-full h-full text-center ">
        <div>
          <h1 className="text-4xl mt-24  sm:text-center sm:text-8xl font-medium text-transparent  
      ...
      <div className="flex justify-center items-center w-full h-full ">
        <div className="flex-col flex gap-14 md:flex-row md:flex sm:flex sm:flex-row justify-center items-center mt-24 mb-24 ">
          ...
          <div className="flex flex-col justify-center items-center ">
            <img src="./images/sujata.jpeg" className="rounded-full h-60" alt="" />
            <h4 className="font-bold">Core Mentor/Instructor</h4>
            <h1 className="font-bold">Ms Sujata Chakravarty</h1>
          </div>

          <div className="flex flex-col justify-center items-center ">
            <img src="./images/rashmi.jpg" className="rounded-full h-60" alt="" />
